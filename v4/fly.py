...
class Fly:
    def __init__(self, image, step_image, size_multiply,x,y):

        self.main_image = pygame.image.load(image)
        self.main_image = pygame.transform.scale(self.main_image, [self.main_image.get_width() * size_multiply, self.main_image.get_height() * size_multiply])
